...
//
//     final anonymousUser = anonymousUserFromJson(jsonString);

import 'dart:convert';

AnonymousUser anonymousUserFromJson(String str) => AnonymousUser.fromJson(json.decode(str));

String anonymousUserToJson(AnonymousUser data) => json.encode(data.toJson());
